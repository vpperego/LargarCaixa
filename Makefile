...
dropboxClient:
	$(CC) -g -o dropboxClient $(SRC_DIR)dropboxClient.c $(SRC_DIR)dropboxUtil.c -Iinclude -lpthread -Wall
#	mv ./dropboxClient.o $(BIN_DIR)

dropboxServer:
	$(CC) -g -o dropboxServer $(SRC_DIR)dropboxServer.c $(SRC_DIR)dropboxUtil.c -Iinclude -lpthread -Wall
